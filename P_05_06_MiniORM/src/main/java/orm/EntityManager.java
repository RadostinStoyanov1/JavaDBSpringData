...
public class EntityManager<E> implements DatabaseContext<E> {
    ...
    private static final String EXISTING_COLUMNS_TEMPLATE = "SELECT COLUMN_NAME FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = 'mini_orm' AND TABLE_NAME = ?";
    ...
    public boolean delete(E entity) throws SQLException, IllegalAccessException {
        ...
        long idValue = fieldId.getLong(entity);
    ...
    private String getColumnsNotExistingInTable(E entity) throws SQLException {
        List<String> existingColumns = getStrings(entity);
    ...
    private List<String> getStrings(E entity) throws SQLException {
        List<String> existingColumns = new ArrayList<>();
        PreparedStatement preparedStatement = connection.prepareStatement(EXISTING_COLUMNS_TEMPLATE);
